		...
		return this.instance
			...
			.then(
				(
					...
					return this.processUserByEmail(
						_response
					);
				}
			);
	...
	protected processAuthSignIn(
		...
		if (status === 200) {
			...
			let resultData200 =
				_responseText;
			result200 =
				AccessTokenDto.fromJS(
					resultData200
				);
			return Promise.resolve<AccessTokenDto>(
				result200
			);
		} else if (
			status !== 200 &&
